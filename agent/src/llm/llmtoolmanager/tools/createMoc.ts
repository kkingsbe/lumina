...
const inputSchemaFieldDescriptions: FieldDescription[] = [
    ...
    },
    {
        ...
        type: "string",
        description: "Use this field to communicate to the user what you are doing. For example, you can use this field to communicate that you are creating a MOC."
    }
];
